...
const Billing = () => (
  <section id='product' className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      max-w-[470px] mt-5`}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
        Assumenda sequi pariatur veniam amet quibusdam autem cupiditate, aperiam 
        accusantium non libero?</p>
